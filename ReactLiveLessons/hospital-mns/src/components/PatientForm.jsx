...
const PatientForm = ({ refreshKey, setRefreshKey, updatingPatient, onClose }) => {
    const [patient, setPatient] = useState(() =>
        updatingPatient ? { ...updatingPatient } : emptyPatient,
    );
    ...
    const handleSubmit = async event => {
        ...
        try {
            ...
            setError(
                "We couldn't save this patient. Confirm the server is running and try again.",
            );
        } finally {
            setIsSaving(false);
        }
            ...
            <div className="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3 px-3 px-md-4">
                <div>
                    <h2 className="h5 fw-bold mb-1">
                        {updatingPatient ? "Edit patient" : "Add a patient"}
                    </h2>
                    <p className="text-secondary small mb-0">
                        All fields are required to keep the record complete.
                    </p>
                </div>
                <button
                    type="button"
            ...
            <div className="card-body p-3 p-md-4">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-end gap-2 border-top mt-4 pt-3">
                        ...
                        <button className="btn btn-primary px-4" disabled={isSaving}>
                            {isSaving
                                ? "Saving…"
                                : updatingPatient
                                  ? "Save changes"
